...
Til projektet er der valgt at bruge en gyro til at bestemme hvilken type sving bilen er i. Til projektet var der mulighed for at få udleveret et analogt og et digitalt accelramometer.\\Det digitale var et LIS35DE som kan måle +- 2G eller +- 8G på 3 akser, og kan lave målinger op til 400 gange i sekundet.\ Det analoge var et MMA1270KEG med kun en akse, der kan måle op til +- 2,5G. Den akse det kan måle på ligger vinkelret på printet som chippen bliver placeret på.\\ I gruppen havde vi en MPU-6050 tilrådighed, som har 3 akset accelramometer, som sender 16bit data ud for hver akse, det er her muligt at sætte følsomheden til: +- 2G, 4G, 8G eller 16G. Men udover at have et accelramometer så har den også en 3 akset gyro, som vi i gruppen havde en ide om kunne gøre det nemmere at se forskel på om det er et stort sving eller et lille sving
